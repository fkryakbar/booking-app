    ...
    <div class="mx-auto w-[50%]" x-show="open == true">
        ...
        <form class="space-y-6" action="" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="price" value="<?= $paket['price'] ?>" name="price" type="number" autocomplete="price" class="block w-full rounded-md border-0 py-1.5 px-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
